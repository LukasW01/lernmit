defmodule Lernmit.Util.S3 do
  ...
  defp config do
    %{
      region: region(),
      access_key_id: Application.fetch_env!(:lernmit, :access_key_id),
      secret_access_key: Application.fetch_env!(:lernmit, :secret_access_key)
    }
  end
  ...
  def bucket do
    Application.fetch_env!(:lernmit, :bucket)
  end

  def region do
    Application.fetch_env!(:lernmit, :region)
  end

  def url do
    Application.fetch_env!(:lernmit, :url)
  end
